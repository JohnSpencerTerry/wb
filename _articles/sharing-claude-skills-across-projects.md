...
An org-wide marketplace with PR-reviewed contributions and per-group install controls is the right amount of infrastructure for a few dozen engineers sharing skills across however many repos they touch. A folder of symlinks is the right amount of infrastructure for one person sharing skills across a handful of personal projects. Copying the same `SKILL.md` around by hand is the wrong amount of infrastructure for either.
